...
import {
  ...
  Phone, Play, QrCode, HeartHandshake, Volume2, VolumeX, MessageCircle, Music, Drama, ChevronDown
} from "lucide-react";
        ...
        <div className="max-w-6xl mx-auto relative z-10">
          <div className="flex flex-col md:flex-row justify-between items-center gap-6 mb-12">
            ...
            <div className="flex flex-wrap justify-center gap-6 text-sm font-bold text-white/60">
              ...
              <a href="#gallery" className="hover:text-[#FFD700] transition-colors">{lang === 'en' ? 'Gallery' : 'గ్యాలరీ'}</a>
