...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-[#fffdf5] mandala-bg selection:bg-[#E25822] selection:text-white pb-24 text-gray-800">
      ...
      <section id="pooja-donors" className="py-12 md:py-16 px-6 relative" style={{ background: 'linear-gradient(180deg, #fffdf5 0%, #fff8ec 100%)' }}>
        <div className="max-w-5xl mx-auto">
          ...
          <div className="flex flex-col items-center gap-3 mb-12 text-center">
            ...
            <h2 className="font-display text-3xl md:text-5xl font-bold text-[#580000] flex items-center gap-2">
              <span className="text-orange-500">🙏</span> {lang === 'en' ? 'Divine Donors' : 'పూజ ఉభయదాతలు'}
            </h2>
            <div className="divider-gold w-32" />
      ...
      <section id="villages" className="py-10 md:py-14 px-6 relative overflow-hidden" style={{ background: 'linear-gradient(135deg, #2a0000 0%, #1a0000 100%)' }}>
        {/* Background Effects */}
        <div className="absolute inset-0 z-0 opacity-10 mandala-bg"></div>
        <div className="absolute top-1/2 right-0 w-[400px] h-[400px] bg-[#FFD700]/10 rounded-full blur-[100px] pointer-events-none -translate-y-1/2"></div>
        <div className="absolute top-1/2 left-0 w-[400px] h-[400px] bg-[#E25822]/10 rounded-full blur-[100px] pointer-events-none -translate-y-1/2"></div>
        
        <div className="max-w-4xl mx-auto relative z-10">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="flex flex-col items-center text-center mb-8 md:mb-10">
            <span className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full border border-[#FFD700]/30 bg-gradient-to-r from-[#FFD700]/20 to-[#FFA500]/10 text-[#FFD700] text-[10px] font-black uppercase tracking-[0.25em] mb-4 shadow-[0_0_15px_rgba(255,215,0,0.2)]">
              <HeartHandshake size={12} /> {lang === 'en' ? 'Divine Unity' : 'పవిత్ర ఐక్యత'}
            </span>
            <h2 className="font-display text-3xl md:text-4xl lg:text-5xl font-black text-transparent bg-clip-text bg-gradient-to-b from-[#FFF] via-[#FFD700] to-[#FFA500] mb-4 drop-shadow-[0_2px_10px_rgba(255,215,0,0.4)]">
              {lang === 'en' ? 'The 24 United Villages' : '24 గ్రామాల ఐక్యత'}
            </h2>
            <p className="text-orange-100/90 max-w-2xl text-sm md:text-base leading-relaxed font-medium text-balance">
              {lang === 'en' 
          ...
          >
            {/* Elegant Quote Box */}
            <div className="absolute inset-0 bg-gradient-to-r from-[#FFD700]/20 via-[#E25822]/20 to-[#FFD700]/20 rounded-3xl blur-xl opacity-60"></div>
            <div className="relative bg-gradient-to-br from-white/10 to-transparent border border-white/20 backdrop-blur-xl rounded-3xl px-6 py-8 md:px-10 md:py-8 shadow-[0_20px_50px_rgba(0,0,0,0.5)] overflow-hidden">
              <div className="absolute -top-10 -right-10 text-[120px] text-[#FFD700] opacity-10 font-serif leading-none select-none pointer-events-none">"</div>
              
              <div className="flex flex-col items-center text-center gap-4 relative z-10">
                <div className="w-10 h-10 bg-gradient-to-br from-[#FFD700] to-[#E25822] rounded-full p-[2px] shadow-lg">
                  <div className="w-full h-full rounded-full bg-[#2a0000] flex items-center justify-center">
                    <span className="text-xl text-[#FFD700] leading-none mt-1 font-serif">❝</span>
                  </div>
                </div>
                
                <p className="text-[#FFD700] text-base md:text-lg font-bold leading-relaxed text-balance max-w-3xl">
                ...
                <div className="w-16 h-1 bg-gradient-to-r from-transparent via-[#E25822] to-transparent rounded-full mt-1"></div>
              </div>
            </div>
          </motion.div>
        </div>
