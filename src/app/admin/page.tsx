                ...
                <div>
                  ...
                  <option value="">-- కార్యక్రమం ఎంచుకోండి / Select Event --</option>
                    <optgroup label="ముఖ్య కార్యక్రమాలు (Main Events)">
                      <option value="శ్రీ మహాభారతయజ్ఞ శ్రీకారము">శ్రీ మహాభారతయజ్ఞ శ్రీకారము — Yagna Inauguration 🪔</option>
                      <option value="ధ్వజారోహణము">ధ్వజారోహణము — Dhwajarohanamu (Flag Hoisting) 🚩</option>
                      <option value="దేవుని ఊరేగింపు">దేవుని ఊరేగింపు — Devuni Uregimpu (Deity Procession / Gramotsavam) 🚶‍♂️</option>
                      <option value="బండి కుంభాలు">బండి కుంభాలు — Bandi Kumballu (Sacred Pots Chariot) 🎡</option>
                      <option value="ద్రౌపతి కళ్యాణం">ద్రౌపతి కళ్యాణం — Draupadi Kalyanam (Wedding Ceremony) 💛</option>
                      <option value="వస్త్రాపహరణం">వస్త్రాపహరణం — Vastraharanam 🧣</option>
                      <option value="రాత్రి ద్రౌపతి మాన సంరక్షణ">రాత్రి ద్రౌపతి మాన సంరక్షణ — Draupadi Mana Samrakshana ⚔️</option>
                      <option value="అర్జున తపస్సు కార్యక్రమం">అర్జున తపస్సు కార్యక్రమం — Arjuna Tapassu (Penance) 🙏</option>
                      <option value="బకాసుర వధ">బకాసుర వధ — Bakasura Vadha (Slaying of Bakasura) 👹</option>
                      <option value="కీచకవధ">కీచకవధ — Keechaka Vadha (Slaying of Keechaka) 🗡️</option>
                      <option value="ఉత్తరగోగ్రహణం">ఉత్తరగోగ్రహణం — Uttaragograhanam (Cattle Retrieval) 🐄</option>
                    ...
                    <optgroup label="రోజువారీ & విశేష కార్యక్రమాలు (Daily & Special)">
                      <option value="హరికథా కార్యక్రమం">హరికథా కార్యక్రమం — Harikatha Programme 🎶</option>
                      <option value="రాత్రి నాటకం">రాత్రి నాటకం — Night Drama 🎭</option>
                      <option value="యాగం / నిత్య పూజ">యాగం / నిత్య పూజ — Yagam / Daily Pooja 🪔</option>
                      <option value="విశేష అలంకరణ">విశేష అలంకరణ — Visesha Alankarana (Special Deity Decoration) ✨</option>
                      <option value="అన్నదానం">అన్నదానం — Annadanam (Sacred Food Distribution) 🍛</option>
                      <option value="సాంస్కృతిక ప్రదర్శనలు">సాంస్కృతిక ప్రదర్శనలు — Cultural Performances / Dances 💃</option>
                    </optgroup>
                    <optgroup label="ఇతర (Other)">
                      <option value="సాధారణ ఫోటో">సాధారణ ఫోటో — General Photo / Temple View 📷</option>
                      <option value="సభ / సమావేశం">సభ / సమావేశం — Sabha / Meeting / Gathering 🏛️</option>
                      <option value="భక్తులు / వాలంటీర్లు">భక్తులు / వాలంటీర్లు — Devotees / Volunteers 🤝</option>
